...
import { mockDailyReports, mockCourses } from '@/shared/utils/mockData';
    ...
    <div className="min-h-screen bg-slate-900 pt-16">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-400">Seguimiento detallado del progreso académico</p>
            </div>
          </div>
        </div>
        ...
        {activeReport === 'daily' && (
          <div>
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-semibold text-white mb-1">Reporte Diario Histórico</h2>
                <p className="text-sm text-slate-400">Seguimiento día a día del avance de cada estudiante</p>
              </div>
              <button className="px-6 py-2.5 bg-green-500 hover:bg-green-400 text-white rounded-lg font-medium transition-colors flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {activeReport === 'course' && (
          <div>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-white mb-1">Reporte por Curso/Grupo</h2>
              <p className="text-sm text-slate-400">Vista consolidada del progreso por curso</p>
            </div>
        ...
        {activeReport === 'tutoring' && (
          <div>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-white mb-1">Reporte de Tutorías</h2>
              <p className="text-sm text-slate-400">Estadísticas de sesiones de validación</p>
            </div>
        ...
        {activeReport === 'student' && (
          <div>
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-white mb-1">Reporte por Estudiante</h2>
              <p className="text-sm text-slate-400">Análisis individual detallado</p>
            </div>
