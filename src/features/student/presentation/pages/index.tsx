    ...
    <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 p-8 border border-slate-700/50">
        ...
        <div className="relative z-10">
          ...
          {/* Grupo y curso asignado */}
          {courses.length > 0 && (
            <div className="flex flex-wrap gap-3 mb-6">
              {courses[0].group && (
                <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-700/60 border border-slate-600/50 rounded-lg">
                  ...
                  <span className="text-[11px] font-black text-slate-300 uppercase tracking-widest">
                    Grupo: <span className="text-purple-400">{courses[0].group.name}</span>
                  </span>
                </div>
              )}
              <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-700/60 border border-slate-600/50 rounded-lg">
                ...
                <span className="text-[11px] font-black text-slate-300 uppercase tracking-widest">
                  {courses.length} {courses.length === 1 ? 'Curso' : 'Cursos'} asignados
                </span>
              </div>
            </div>
          )}
