...
export function AdminHeader({ activeTab, setActiveTab }: AdminHeaderProps) {
  const tabs = [
    ...
    { id: 'tutors', label: 'Tutores', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    ...
    { id: 'submissions', label: 'Retos', icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4' },
    { id: 'tutoring', label: 'Tutorías', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
