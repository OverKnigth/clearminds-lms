      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm sm:text-base text-slate-400">Gestiona estudiantes, cursos y seguimiento de progreso</p>
            </div>
            <button
              onClick={() => window.location.href = '/admin/reports'}
              className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-purple-500 hover:bg-purple-400 text-white rounded-lg text-sm sm:text-base font-medium transition-colors flex items-center justify-center gap-2"
            >
        ...
        {activeTab === 'students' && (
          <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-4">
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-1">Gestión de Estudiantes</h2>
                <p className="text-xs sm:text-sm text-slate-400">Administra usuarios, credenciales y asignaciones</p>
              </div>
              <button
                onClick={() => openModal('addStudent')}
                className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white rounded-lg text-sm sm:text-base font-medium transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {activeTab === 'courses' && (
          <div>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-4">
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-white mb-1">Gestión de Cursos</h2>
                <p className="text-xs sm:text-sm text-slate-400">Administra contenido, módulos y videos</p>
              </div>
              <button
        ...
        {activeTab === 'progress' && (
          <div>
            <div className="mb-4 sm:mb-6">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-1">Seguimiento de Progreso</h2>
              <p className="text-xs sm:text-sm text-slate-400">Monitorea el avance por generación y módulo</p>
            </div>
        ...
        {activeTab === 'assignments' && (
          <div>
            <div className="mb-4 sm:mb-6">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-1">Asignación de Cursos</h2>
              <p className="text-xs sm:text-sm text-slate-400">Habilita o deshabilita cursos para cada estudiante</p>
            </div>
